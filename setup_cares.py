...
cares_sources = [
    ...
    'deps/c-ares/src/ares__parse_into_addrinfo.c',
    'deps/c-ares/src/ares__read_line.c',
    'deps/c-ares/src/ares__readaddrinfo.c',
    'deps/c-ares/src/ares__sortaddrinfo.c',
    ...
    'deps/c-ares/src/ares_freeaddrinfo.c',
    'deps/c-ares/src/ares_getaddrinfo.c',
