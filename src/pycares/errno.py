...
errorcode = {
    _lib.ARES_SUCCESS: "ARES_SUCCESS",
    # error codes
    _lib.ARES_ENODATA: "ARES_ENODATA",
    _lib.ARES_EFORMERR: "ARES_EFORMERR",
    _lib.ARES_ESERVFAIL: "ARES_ESERVFAIL",
    _lib.ARES_ENOTFOUND: "ARES_ENOTFOUND",
    _lib.ARES_ENOTIMP: "ARES_ENOTIMP",
    _lib.ARES_EREFUSED: "ARES_EREFUSED",
    _lib.ARES_EBADQUERY: "ARES_EBADQUERY",
    _lib.ARES_EBADNAME: "ARES_EBADNAME",
    _lib.ARES_EBADFAMILY: "ARES_EBADFAMILY",
    _lib.ARES_EBADRESP: "ARES_EBADRESP",
    _lib.ARES_ECONNREFUSED: "ARES_ECONNREFUSED",
    _lib.ARES_ETIMEOUT: "ARES_ETIMEOUT",
    _lib.ARES_EOF: "ARES_EOF",
    _lib.ARES_EFILE: "ARES_EFILE",
    _lib.ARES_ENOMEM: "ARES_ENOMEM",
    _lib.ARES_EDESTRUCTION: "ARES_EDESTRUCTION",
    _lib.ARES_EBADSTR: "ARES_EBADSTR",
    _lib.ARES_EBADFLAGS: "ARES_EBADFLAGS",
    _lib.ARES_ENONAME: "ARES_ENONAME",
    _lib.ARES_EBADHINTS: "ARES_EBADHINTS",
    _lib.ARES_ENOTINITIALIZED: "ARES_ENOTINITIALIZED",
    _lib.ARES_ELOADIPHLPAPI: "ARES_ELOADIPHLPAPI",
    _lib.ARES_EADDRGETNETWORKPARAMS: "ARES_EADDRGETNETWORKPARAMS",
    _lib.ARES_ECANCELLED: "ARES_ECANCELLED",
    _lib.ARES_ESERVICE: "ARES_ESERVICE",
}
