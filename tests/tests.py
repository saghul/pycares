...
class DNSTest(unittest.TestCase):
    ...
    def test_query_txt_chunked(self):
        ...
        self.assertEqual(
            self.result[0].text,
            b"v=spf1 include:emailcampaigns.net include:spf.dynect.net  include:ccsend.com include:_spf.elasticemail.com ip4:67.200.116.86 ip4:67.200.116.90 ip4:67.200.116.97 ip4:67.200.116.111 ip4:74.199.198.2  ~all",
        )
    ...
    def test_query_class_chaos(self):
        ...
        self.channel.query(
            "id.server", pycares.QUERY_TYPE_TXT, cb, pycares.QUERY_CLASS_CHAOS
        )
        self.wait()
        self.assertNoError(self.errorno)
    ...
    def test_query_ptr(self):
        ...
        ip = "8.8.8.8"
        self.channel.query(
            ipaddress.ip_address(ip).reverse_pointer, pycares.QUERY_TYPE_PTR, cb
        )
        self.wait()
        self.assertNoError(self.errorno)
    ...
    def test_query_bad_type(self):
        self.assertRaises(
            ValueError, self.channel.query, "google.com", 667, lambda *x: None
        )
        self.wait()
